...
public class NMSUtil {
    ...
    public static CraftBoat spawnBoat( Location loc, Plugin plugin ) {
        CraftWorld cw = ( (CraftWorld) loc.getWorld() );
        CustomBoat a = new CustomBoat( cw.getHandle(), loc.getX(), loc.getY(), loc.getZ() );
        cw.getHandle().addEntity( a, CreatureSpawnEvent.SpawnReason.CUSTOM );
        return new CraftBoat( (CraftServer) Bukkit.getServer(), a );
    }
